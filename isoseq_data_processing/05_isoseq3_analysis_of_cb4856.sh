...
mkdir /mnt/3main/lotusbo/isoseq.analysis/cb4856/
mkdir /mnt/3main/lotusbo/isoseq.analysis/cb4856/isoseq3.one
export workDirectory="/mnt/3main/lotusbo/isoseq.analysis/cb4856/isoseq3.one"
export sname="cb4856"
...
ccs /mnt/3main/junkim/isoseq/CB/m54229_191004_212459.subreads.bam ${workDirectory}/ccs/${sname}.isoseq.ccs.bam --min-rq 0.8 --min-passes 1 --num-threads 17
...
minimap2 -t 17 -ax splice -uf --secondary=no -C5 -O6,24 -B4 /mnt/3main/lotusbo/isoseq.analysis/resources/cb4856/cb4856.scaffold.gapfilling.mt.wrapped.rename.fasta ${workDirectory}/polish/${sname}.polished.hq.fasta.gz > ${workDirectory}/minimap2/${sname}.hq_isoforms.fasta.sam 2> ${workDirectory}/minimap2/${sname}.hq_isoforms.fasta.sam.log
